...
import ru.pgk63.core_common.api.journal.model.CreateJournalBody
...
internal class CreateJournalViewModel @Inject constructor(
    ...
    private val _responseCreateJournalResult = MutableStateFlow<Result<Journal?>?>(null)
    val responseCreateJournalResult = _responseCreateJournalResult.asStateFlow()

    fun createJournal(body: CreateJournalBody) {
