            ...
            val visibleDeleteButton: Boolean = if(user.userRole != null){
                when (user.userRole) {
                    ...
                    UserRole.DEPUTY_HEADMAN, UserRole.HEADMAN -> {
                        !type.row.confirmation || raportichka?.headman?.id == user.userId ||
                                raportichka?.deputyHeadma?.id == user.userId
                    }
                    else -> false
                }
            }else false
        ...
        RaportichkaSheetType.AddRaportichkaMenu -> {
            ...
            val visibleAddRowButton: Boolean = if(user.userRole != null && raportichka != null){
                when(user.userRole){
                    UserRole.ADMIN -> true
                    UserRole.DEPUTY_HEADMAN, UserRole.HEADMAN -> {
                        raportichka.headman.id == user.userId || raportichka.deputyHeadma.id == user.userId
                    }
                    else -> false
                }
            }else {
