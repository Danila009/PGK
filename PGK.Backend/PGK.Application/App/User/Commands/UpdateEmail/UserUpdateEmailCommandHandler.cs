...
namespace PGK.Application.App.User.Commands.UpdateEmail
{
        ...
        : IRequestHandler<UserUpdateEmailCommand, MessageModel>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            sentEmailVerificationMessageHtml = sentEmailVerificationMessageHtml.Replace("{{url}}", $"{Constants.BASE_URL}/User/{user.Id}/Email/Pasword/Reset.html?token={sendEmailToken}");
